...
def draw(images, num_dets, labels, boxes, scores, ratios, thrh=0.4):
    for i, im in enumerate(images):
        ...
        for j, b in enumerate(box):
            b[0:4:2] = b[0:4:2] * ratios[0]
            b[1:4:2] = b[1:4:2] * ratios[1]
...
def process_image(m, file_path, device):
    ...
    output = m(blob)
    result_images = draw([im_pil], output["num_dets"], output["det_classes"],
        output["det_boxes"], output["det_scores"], (w/size, h/size))
